...
// 获取音频元数据
std::string XAudioManager::getAudioTitleUnicode(const std::string &audio) {
    return engin->get_audio_titleunicode(audio);
}
std::string XAudioManager::getAudioArtistUnicode(const std::string &audio) {
    return engin->get_audio_artistunicode(audio);
}
