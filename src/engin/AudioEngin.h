...
class XAudioEngin {
    ...
    bool is_indevice_exist(int device_index,
    ...
    // 获取音频元数据
    std::string get_audio_titleunicode(const std::string &auido);
    std::string get_audio_artistunicode(const std::string &auido);
